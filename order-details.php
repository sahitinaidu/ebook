...
?>
				<tr>
					...
					<td>
 <a href="admin/productimages/<?php echo $row['proid'];?>/<?php echo $row['upload'];?>"  target="_blank" download>
					Download</td>
				</tr>
<?php $cnt=$cnt+1;} } else { ?>
