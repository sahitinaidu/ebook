...
<div class="control-group">
<label class="control-label" for="basicinput">Publication Company</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Book Price After Discount</label>
<div class="controls">
...
<div class="controls">
<img src="productimages/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['bookupload']);?>" width="200" height="100"> <a href="update-book.php?id=<?php echo $row['id'];?>">Change Book</a>
</div>
</div>
